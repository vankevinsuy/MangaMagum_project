def insert_all():
    ...
    #fill manga table
    with open("D:\MangaMagum_project\Server\python_serveur\dev\outpout\manga.csv") as manga_file:
    ...
    #fill chapter table
    with open("D:\MangaMagum_project\Server\python_serveur\dev\outpout\chapters.csv") as chapter_file:
        ...
        mycursor.executemany(sql, to_insert)
        mydb.commit()
        print(mycursor.rowcount, " chapters was inserted.")
        to_insert.clear()
        chapter_file.close()
        to_insert.clear()
    #----------------------------------------------------------------------------------------------------
    ...
    # fill page table
    with open("D:\MangaMagum_project\Server\python_serveur\dev\outpout\pages.csv") as page_file:
        ...
        for row in to_insert:
            ...
            mydb.commit()
            print(mycursor.rowcount, "pages was inserted.")
            manga_file.close()
        to_insert.clear()