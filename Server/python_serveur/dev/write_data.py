...
def write_manga(dictionnary,id_book):
    with open("/home/van-kevin/Documents/MangaMagum_project/Server/python_serveur/dev/outpout/manga.csv",'a') as manga_csv:
...
def chapter_recursif(id_book, urls_base,chapitre, indice_liste, list_chapitre):
    with open("/home/van-kevin/Documents/MangaMagum_project/Server/python_serveur/dev/outpout/chapters.csv",'a') as chapter_csv:
...
def write_page(dictionnary, id_book):
    with open('/home/van-kevin/Documents/MangaMagum_project/Server/python_serveur/dev/outpout/chapters.csv', 'r') as csv_file:
        with open('/home/van-kevin/Documents/MangaMagum_project/Server/python_serveur/dev/outpout/pages.csv', 'a') as page_csv:
