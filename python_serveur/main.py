...
from Url_page_checker import *

input_file = open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/input_file.txt").readlines()

# ecriture de manga.csv
with open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/out/manga.csv", 'w') as manga_csv:
...
with open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/out/manga.csv",'r') as csvfile:
    with open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/out/chapitre.csv", 'w') as chapitre_csv :
...
with open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/out/chapitre.csv", 'r') as chapitre:
    with open("/home/van-kevin/Desktop/MangaMagum_project/python_serveur/out/pages.csv", 'w') as page:
